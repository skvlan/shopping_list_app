...
class GroceryItemCreate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "quantity", "unit", "category", "notes"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of GroceryItemCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of GroceryItemCreate from a dict"""
        if obj is None:
            return None
